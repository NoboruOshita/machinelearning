...
class data_ransomware(models.Model):
    id_data_ransomware=models.IntegerField(primary_key=True)
    id_user_id=models.ForeignKey('auth_user', on_delete=models.CASCADE)
    id_blacklist_id=models.ForeignKey('blacklist', on_delete=models.CASCADE)
...
class detector_rf(models.Model):
    id_detector_rf=models.IntegerField(primary_key=True)
...
class detector_xgboost(models.Model):
    id_detector_xgb=models.IntegerField(primary_key=True)
    id_detection_id=models.ForeignKey('detection', on_delete=models.CASCADE)
    precision=models.FloatField(null=True, blank=True)
    accuracy=models.FloatField(null=True, blank=True)
    recall=models.FloatField(null=True, blank=True)
